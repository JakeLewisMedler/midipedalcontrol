...
String inputString = "";
int midiChannel = 1;
Pedal pedals[] = { Pedal(A9, A8, 5, 7), Pedal(A7, A6, 2, 3), Pedal(A3, A2, 14, 15), Pedal(A1, A0, A10, 16) };
...
void sendPedalMidi(int pedalId) { controlChange(pedals[pedalId - 1].cc, pedals[pedalId - 1].value); }
